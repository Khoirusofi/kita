...
<body class="font-['Poppins'] text-gray-900 antialiased">
    ...
    <!-- Back to top button -->
    <a href="#"
        class="scrollup px-2 py-2 bg-pink-600 text-white rounded-md font-medium text-sm hover:bg-pink-900 transition duration-300 transform hover:-translate-y-1 fixed right-10 bottom-10 inline-flex z-10 opacity-0 pointer-events-none"
        id="scroll-up">
