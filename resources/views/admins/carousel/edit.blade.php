        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admins.carousel.update', $carousel) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <div>
                                ...
                                <input type="text" name="title1" id="title1"
                                    value="{{ old('title1', $carousel->title1) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="title2" id="title2"
                                    value="{{ old('title2', $carousel->title2) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    required>
                                @error('title2')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                            ...
                            <div>
                                ...
                                <input type="text" name="title3" id="title3"
                                    value="{{ old('title3', $carousel->title3) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    required>
                                @error('title3')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
